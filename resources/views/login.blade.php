...
<div class="main-login-div">
    <div class="side-bar"><br><br><br><br><br> <br><br>
        <h1 class="titlename">Instant Convert</h1>
    ...
    <div class="login-page">
        <div class="form">
          ...
          <form action="{{route('userlogin')}}" method="post" class="login-form">
            ...
            @enderror
            <input style="background-color:#3e6b98; color:white;" type="submit" value="Login">
            <p class="message">Not registered? <a style="color: #091944; font-weight:700;" href="/register">Create an account</a></p>
          </form>
        </div>
