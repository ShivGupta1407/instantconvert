        ...
        <div class="session-note">
            @if (Session::has('success'))
                <p id="success-message"
                    style="position:absolute; text-align:center; color:rgb(29, 71, 29); background-color:aquamarine; width:300px; padding:10px;">
                    {{ Session::get('success') }}</p>
            @endif
        </div>
        
        <form action="/admin/storeuniversity" method="POST" >
            <div style="display: flex; justify-content:space-between;">
                <div><h1>Add New University</h1></div>
                <div> <button type="submit">Add university</button></div>
                </div><br>
            @csrf
